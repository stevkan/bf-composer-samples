    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    CosmosDbEndpoint = m_botSettings.CosmosDbEndpoint,
                    AuthKey = m_botSettings.CosmosDbAuthKey,
                    DatabaseId = BotConstants.CosmosDBId,
                    ContainerId = BotConstants.CosmosDBContainerId
                };
